...
class MachinesApi
{
     ...
     * @param  \Swagger\Client\Model\GroupParam4 $group_param Group ID to query. (required)
     *
     ...
     *
     * @param  string $access_token Samsara API access token. (required)
     * @param  \Swagger\Client\Model\HistoryParam1 $history_param Group ID and time range to query for events (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
